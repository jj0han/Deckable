...
const ButtonNavComponent = ({ title, navigation, screen, border = false, fullWidth = false }) => {
    return (
        <TouchableOpacity onPress={() => navigation.navigate(screen)} style={{ width: fullWidth ? "100%" : "70%" }} className="mb-4 h-12">
