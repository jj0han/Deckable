      ...
      <FormLayout>
        <FormikForm
          ...
          <View className="w-full">
            <Text className="text-black text-3xl font-semibold tracking-widest">
              {type === 'signup' ? 'Cadastrar' : 'Entrar'}
            </Text>
            <Text className="text-[#666666] text-base font-semibold">
          ...
          <View className="w-full items-center">
            <View className="w-full flex-row justify-center items-center my-5">
              ...
              <Text className="text-base text-center text-[#666666] font-semibold mx-2">
                Ou
              </Text>
              <View className="border-b border-[#d7d7d7] grow" />
            </View>
            <TouchableOpacity
              ...
              className="bg-[#F7F7F7] border-[#D7D7D7] border-[1px] px-4 rounded-lg w-full h-12 flex-row justify-center items-center">
              <Google />
              <Text className="text-[#8a8a8a] font-semibold ml-5">
