...
const signupSchema = Yup.object().shape({
    ...
    password: Yup.string()
        ...
        .matches(/^[a-zA-Z0-9!@#$%^&*()_+{}|:?><~?><~,./]{6,20}$/, 'A senha deve ter de 6 a 20 caracteres')
        .label("password"),
    confirmPassword: Yup.string().test('passwords-match', 'As senhas não coincidem', function (value) {
...
const createDeckSchema = Yup.object().shape({
  ...
  export { basicCardSchema, qaCardSchema, loginSchema, signupSchema, createDeckSchema }