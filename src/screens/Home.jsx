            ...
            <ScrollView>
                ...
                </View>
                {
                    loading ?
                        ...
                        render.length === 0 ?
                            <>
                                <Text className="text-black text-lg font-bold text-center p-6">Parece que você ainda não tem nenhum Deck...</Text>
                                <DeckComponent title={"Comece criando um novo Deck!"} navigate={navigation.navigate} screen={"Criar"} params={null} />
                            </>
                            :
                            <>
