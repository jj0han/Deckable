    ...
    <>
      ...
      <Swiper
        ...
        onSwipedRight={cardIndex => {
          ...
          updateCard(
            updatedCards[cardIndex].content.question,
            updatedCards[cardIndex].content.answer,
            updatedCards[cardIndex].type,
            updatedCards[cardIndex].id,
            id,
            cardIndex,
            updatedCards[cardIndex].uid,
            updatedCards[cardIndex].createdAt,
            updatedCards[cardIndex].lastReviewed,
            updatedCards[cardIndex].nextReview,
            updatedCards[cardIndex].difficulty,
          );
        }}
              ...
              <View className="relative w-[255px] h-[330px] mx-auto my-1">
                ...
                <View className="absolute w-full h-full p-4 justify-between items-center">
                  <Text
                    ...
                    className="text-white font-bold text-center break-words m-auto">
